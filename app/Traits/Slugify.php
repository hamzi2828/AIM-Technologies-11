...
/**
    ...
    */
    ...
    protected function getSlug($string, $separator = '-')
    {
        $slug = '';
        $lastCharacter = '';
        ...
        for ($i = 0; $i < mb_strlen($string, 'utf-8'); $i++)  {
            $tempCharacter = $this->utf8_substr($string, $i, 1);
            $currentCharacter = $this->convertCharacter($tempCharacter, $separator);
    ...
    */
    ...
    private function convertCharacter($character, $separator)
    {
